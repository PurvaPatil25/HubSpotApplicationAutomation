...
// /**
// * @see
// com.beust.testng.ITestListener#onTestSuccess(com.beust.testng.ITestResult)
// */
...
// Paragraph(result.getTestClass().toString()));
// this.successTable.addCell(cell);
// cell = new PdfPCell(new
// Paragraph(result.getMethod().getMethodName().toString()));
// this.successTable.addCell(cell);
// cell = new PdfPCell(new Paragraph("" + (result.getEndMillis() -
...
// /**
// * @see
// com.beust.testng.ITestListener#onTestFailure(com.beust.testng.ITestResult)
// */
...
// /**
// * @see
// com.beust.testng.ITestListener#onTestSkipped(com.beust.testng.ITestResult)
// */
...
// log("onStart(" + context + ")");
// try {
// PdfWriter.getInstance(this.document, new FileOutputStream(context.getName() +
// ".pdf"));
// } catch (Exception e) {
// e.printStackTrace();
// }
...
// FontFactory.getFont(FontFactory.HELVETICA, 20, Font.BOLD, new Color(0, 0,
// 255)));
//
// try {
// this.document.add(p);
...
// FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new Color(255, 0,
// 0)));
